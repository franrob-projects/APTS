...
const features = [
      ...
      <>
        <ul className="space-y-2">
          {[
            ...
            "Citizenship, Diversity, and Behaviour (psychology and discipline)",
            "Global Affairs, Media, and the Uniformed Protective Services",
          ].map((item) => (
  ...
  {
    name: "Duke of Edinburgh (DofE) award",
    description: (
      <>
