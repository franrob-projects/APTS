...
const features = [
  {
    name: "Social sciences and citizenship",
    description: (
      <>
        <ul className="space-y-1">
          {[
            "Citizenship and diversity",
            "Behaviour and discipline (psychology)",
  ...
  {
    name: "Personal development and wellbeing",
    description: (
      <>
  ...
  {
    name: "Practical skills and emergency preparedness",
    description: (
      <>
        <ul className="space-y-2">
          {[
